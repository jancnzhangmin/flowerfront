...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="待评价"
          ...
          <div class="x-titlebar-title" style="font-weight:normal;color:#333333;">待评价</div>  
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row10">
   ...
   <i xid="i8"></i>
   <span xid="span19">查看物流</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-sm process-btn" label="评价商品" xid="commentBtn" bind-visible=' val("orderstatus") == 3' onClick="commentBtnClick">
   <i xid="i1"></i>
