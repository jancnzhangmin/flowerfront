...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   ...
   <div class="x-contents-content" xid="topsalecontent"><div component="$UI/system/components/justep/windowContainer/windowContainer" class="x-window-container" xid="windowContainer1" src="./topsale/topsale.w"></div></div>
  ...
  <div class="x-contents-content" xid="owercontent"><div component="$UI/system/components/justep/windowContainer/windowContainer" class="x-window-container" xid="windowContainer3" src="$UI/flowerfront/ower/ower.w"></div></div>
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-icon-top" label="首页" xid="button1" target="topsalecontent" icon="my my-songhua">
    <i xid="i1" class="my my-songhua"></i>
