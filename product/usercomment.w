...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column name="updated_at" type="String" xid="xid9"></column></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" 
   ...
   <ul class="x-list-template" xid="listTemplateUl1" style="padding-left:5px;padding-right:5px;">
    <div xid="div1" class="col-xs-12 col-sm-12" style="padding:5px;"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" style="padding:0px;">
  ...
  <div xid="div4" bind-visible=' val("anonymous") == 1' style="padding-top:2px;"><i xid="i1" class="my2 my2-niming text-muted" bind-visible=' val("anonymous") == 1' style="font-size:large;margin-top:15px;"></i></div></div>
   <div class="x-col" xid="col4"><span xid="span2" bind-text=" val(&quot;anonymous&quot;) != 1 ? val(&quot;nickname&quot;) : '匿名'" class="text-muted" style="font-size:small;"></span></div>
  <div class="x-col text-right" xid="col8"><span xid="span6" bind-text='val("updated_at")' class="text-muted"></span></div></div><div xid="div3" style="padding-top:5px;padding-left:33px;">
  <span xid="span1" bind-text='val("comment")' class="textout"></span></div><div xid="div2" style="border-radius:5px 5px 0px 0px;overflow: hidden;"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list2" data="$model.commentimgData" filter=' $row.val("comment_id") == val("id")'>
   <ul class="x-list-template" xid="listTemplateUl2" style="padding-left:32px;">
    <div xid="div11" class="col-xs-6 col-sm-4" style="padding:2px;"><img src=" " alt="" xid="image1" bind-attr-src=' val("commentimg")' style="width:100%;border-radius:5px;overflow: hidden;"></img></div></ul> 
  </div></div>
